...
class QuestionDisplay extends Component {
	...
	render() {
		...
		let theHead = this.context.head ? this.context.head : {};

		return (
			<>
				<div className="question_group">
					<div className="question_item">
						<h2 className="translate_word">Translate the word:</h2>
						<span className="translation_word">{nextWordUp}</span>
					</div>
					<div className="question_item">
						<p className="DisplayScore">Your total score is: {theScore}</p>
					</div>
				</div>
				<div className="translation_group">
					<br />
					<span>
						You have answered this word correctly {theHead.wordCorrectCount}{" "}
						times.
					</span>
					<br></br>
					<span>
						You have answered this word incorrectly {theHead.wordIncorrectCount}{" "}
						times.
					</span>
				</div>
